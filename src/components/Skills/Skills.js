...
import { faReact, faHtml5, faCss3Alt, faJs, faPython, faPhp, faRProject, faAndroid, faFigma, faNode, faJava } from '@fortawesome/free-brands-svg-icons';
...
export default function Skills() {
  return (
    ...
    <div className='skill_box_holder'>
      ...
      <div className="skill-box"><FontAwesomeIcon className='ficon' icon={faJava} style={{ color: 'cyan' }} /><br />Java</div>
      ...
      <div className="skill-box"><FontAwesomeIcon className='ficon' icon={faDatabase} style={{ color: 'gray' }} /><br />MongoDB</div>
      <div className="skill-box"><FontAwesomeIcon className='ficon' icon={faNode} style={{ color: 'green' }} /><br />Nodejs</div>
